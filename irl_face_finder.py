...
def detect_bounding_box(vid):
    ...
    for (x, y, w, h) in faces:
        ...
        # Adding a confidence text below the bounding box
        confidence = "Conf: 95%"  # This is a placeholder. Adjust based on your needs.
        cv2.putText(vid, confidence, (x, y + h + 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
    return faces
